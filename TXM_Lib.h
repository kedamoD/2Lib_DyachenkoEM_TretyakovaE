...
void Draw_Hedgehog (int x, int y, int h_size, int step, bool eyesOpen)
{
    ...
    txSetColor(TX_BLACK);
    txSetFillColor (TX_BLACK);
      POINT needle[19] = {{x - (int) h_size * 20.7, y - (int) h_size * 1.1},
                          {x - (int) h_size * 26.2, y - (int) h_size * 3.5},
                          {x - (int) h_size * 19.2, y - (int) h_size * 2.6},
                          {x - (int) h_size * 22.4, y - (int) h_size * 6.9},
                          {x - (int) h_size * 17.9, y - (int) h_size * 3.2},
                          {x - (int) h_size * 17.9, y - (int) h_size * 9.8},
                          {x - (int) h_size * 15.5, y - (int) h_size * 3.5},
                          {x - (int) h_size * 14.7, y - (int) h_size * 10.7},
                          {x - (int) h_size * 13.6, y - (int) h_size * 3.7},
                          {x - (int) h_size * 11.7, y - (int) h_size * 10.5},
                          {x - (int) h_size * 11.1, y - (int) h_size * 3.7},
                          {x - (int) h_size * 8.3, y - (int) h_size * 10.6},
                          {x - (int) h_size * 9.3, y - (int) h_size * 3.4},
                          {x - (int) h_size * 4.1, y - (int) h_size * 11.7},
                          {x - (int) h_size * 7.6, y - (int) h_size * 3.1},
                          {x - (int) h_size * 2.2, y - (int) h_size * 6.3},
                          {x - (int) h_size * 5.7, y - (int) h_size * 2.5},
                          {x + (int) h_size * 0.4, y - (int) h_size * 5.2},
                          {x - (int) h_size * 4.6, y - (int) h_size * 0.9}};
